...
kubectl apply -f $DIR/simple-topic-KAFKA-221.yaml -n lightbend
kubectl apply -f $DIR/kafka-consumer-tests-KAFKA-221.yaml -n seglo
kubectl apply -f $DIR/producer-KAFKA-221.yaml -n seglo
